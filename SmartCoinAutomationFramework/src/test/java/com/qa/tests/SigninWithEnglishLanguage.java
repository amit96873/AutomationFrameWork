...
public class SigninWithEnglishLanguage extends BaseTestForSigninSignUp {
	...
	@Description("Verify Select English language  Button and clicked on Continue With English Language Button and after verification it will jump on Permission page")
	@Epic("EP0012")
	@Feature("Feature2: Select English Language and clicked on Continue Button")
	@Story("Story: Select English Language and then Clicked on continue button to get Permission Page")
	@Step("Select English Language and Clicked On continue Button the get Permission Page")
	@Severity(SeverityLevel.MINOR)
