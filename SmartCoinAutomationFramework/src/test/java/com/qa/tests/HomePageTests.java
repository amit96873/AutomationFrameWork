...
public class HomePageTests extends BaseTest {
	...
	public void checkChatShortCutButton() {
		...
		String expectedResult=strings.get("chatpage_Title_Text");
		Assert.assertEquals(actualResult, expectedResult);
		sa.assertAll();	
		System.out.println("actual title - " + actualResult + "\n" + "expected title - "+expectedResult);	
	}
	...
	public void checkVerifyMobileNumberButton() {
		...
		String expectedResultb=strings.get("homePage_Title_Text");
		...
		String expectedResult=strings.get("numberverification_Title_Text");
		Assert.assertEquals(actualResult, expectedResult);
		sa.assertAll();	
		System.out.println("actual title - " + actualResult + "\n" + "expected title - "+expectedResult);	
	...
	public void checkUploadBankAccountStatementButton() {
		...
		String expectedResult=strings.get("bankstatementpage_Title_Text");
		Assert.assertEquals(actualResult, expectedResult);
		sa.assertAll();	
		System.out.println("actual title - " + actualResult + "\n" + "expected title - "+expectedResult);	
	...
	public void checkEarnCoinsButton() {
		...
		String expectedResult=strings.get("SmartCoinRewardsPage_Title_Text");
		Assert.assertEquals(actualResult, expectedResult);
		sa.assertAll();	
		System.out.println("actual title - " + actualResult + "\n" + "expected title - "+expectedResult);	
	...
	public void checkMyKhataButton() {
		...
		String expectedResult=strings.get("mykhataPage_Title_Text");
		Assert.assertEquals(actualResult, expectedResult);
		sa.assertAll();	
		System.out.println("actual title - " + actualResult + "\n" + "expected title - "+expectedResult);	
	...
	public void checkMyProfileButton() {
		...
		String expectedResult=strings.get("myprofilePage_Title_Text");
		Assert.assertEquals(actualResult, expectedResult);
		sa.assertAll();	
		System.out.println("actual title - " + actualResult + "\n" + "expected title - "+expectedResult);	
	...
	public void checkContactUsButton() {
		...
		String expectedResult=strings.get("helpandsupportPage_Title_Text");
		Assert.assertEquals(actualResult, expectedResult);
		sa.assertAll();	
		System.out.println("actual title - " + actualResult + "\n" + "expected title - "+expectedResult);	
