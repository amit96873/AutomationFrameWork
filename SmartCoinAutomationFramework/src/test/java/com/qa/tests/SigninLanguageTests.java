...
public class SigninLanguageTests extends BaseTestForSigninSignUp {
	...
	public void checkSignInButton() {
		...
		utils.log().info("actual title - " + actualLanguageTitle + "\n" + "expected title - "+expectedLangaugeTitle);
		...
		utils.log().info("actual title - " + actualpermissionTitle + "\n" + "expected title - "+expectedpermissionTitle);
		...
		utils.log().info("actual title - " + actualaccessSmsTitle + "\n" + "expected title - "+expectedaccessSmsTitle);
		...
		utils.log().info("actual title - " + actualaccessContatsTitle + "\n" + "expected title - "+expectedaccessContatsTitle);
		...
		utils.log().info("actual title - " + actualaccessPhoneCallsTitle + "\n" + "expected title - "+expectedaccessPhoneCallsTitle);
		...
		utils.log().info("actual title - " + actualaccessLocationTitle + "\n" + "expected title - "+expectedaccessLocationTitle);
